...
namespace IPISserver.Handlers
{
    public class GendersHandler
    {
        ...
        public string? InsertNewRow(GendersModel model) => DBCommands.Insert(PeopleModel.tableName,new List<string> {model.gender});
        ...
        /// <param name="model">Model of `Genders` table object</param>
        /// <returns>null if request done successfully. Else - error message</returns>
        public string? UpdateRow(GendersModel model) => DBCommands.Update(PeopleModel.tableName, model.id, PeopleModel.columnsNames ,new List<string> {model.gender});
        ...
        /// <param name="id">specific row id</param>
        /// <returns>null if request done successfully. Else - error message</returns>
        public string? DeleteRow(int id) => DBCommands.Delete(PeopleModel.tableName, new List<int>{ id });
    }
}