    ...
    public partial class MainForm : Form
    {
        ...
        private void FileCreation()
        {
            ...
            try
            {
                ...
                month = monthsList[Convert.ToInt32(dateTimePicker.Value.ToString("MM"))];
        ...
        #region ToolStrip/StatusStrip
        private void savePathShow() => toolStripStatusLabelSavePath.Text = "Save path: " + folderPath;
        ...
        private void toolStripButton2_Click(object sender, EventArgs e) => new Author().Show();
        #endregion
        ...
        private void textBoxINN_KeyPress(object sender, KeyPressEventArgs e) => DigitsWithSlash(sender, e);
        private void textBoxORGN_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxBIK_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxAccountRash_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxAccountCorr_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxPhone_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxSpeed_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxCost_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxIP_KeyPress(object sender, KeyPressEventArgs e) => DigitsWithDots(sender, e);
        private void textBoxMask_KeyPress(object sender, KeyPressEventArgs e) => DigitsWithDots(sender, e);
        private void textBoxGateway_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        private void textBoxLineParams_KeyPress(object sender, KeyPressEventArgs e) => DigitsOnly(sender, e);
        #endregion
    }
}
